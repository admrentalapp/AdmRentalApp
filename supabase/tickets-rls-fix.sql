...
grant execute on function public.client_update_ticket(uuid, uuid, uuid, timestamptz, text, text, text, text) to authenticated;
...
-- Cliente: exclui chamados da própria empresa
